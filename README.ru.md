...
- [Зависимсоти библиотеки](#зависимсоти-библиотеки)
- [Лицензия](#лицензия)
...
Сборка библиотеки осуществляется с помощию сценария **build.bat** или CMake вручную (компиляция Debug версии библиотеки):
...
2. Свойства->Свойства конфигурации->Компоновщик->Общие->Дополнительные каталоги библиотек, указать путь к библиотеке (папка с собранным файлом PATH/build/whatsapp-api-client-cpp.lib)
...
Сборка библиотеки осуществляется с помощию сценария **build.sh** (`sudo sh build.sh`) или вручную:
